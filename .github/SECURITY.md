...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/harvard-dehallucinator/security/advisories/new)
...
- This repository (`hyperpolymath/harvard-dehallucinator`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/harvard-dehallucinator/security/advisories)
...
When using Harvard Dehallucinator, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/harvard-dehallucinator/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/harvard-dehallucinator/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/harvard-dehallucinator/discussions) |
...
*Thank you for helping keep Harvard Dehallucinator and its users safe.* 🛡️
