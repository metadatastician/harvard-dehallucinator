...
# This repo: `harvard-dehallucinator`  ·  clade `rm-harvard-dehallucinator`

- **Identity** — uuid `a5ea1382-a34c-5334-8a46-a2ebe904c810`; clade `rm` (secondary `gv`); born 2026-03-16; forge `hyperpolymath/harvard-dehallucinator`.
...
- **Where it sits** — pipeline position **foundation**; chain `standards → harvard-dehallucinator → (every estate repo)`; coordination = `standards`.
