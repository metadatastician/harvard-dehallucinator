...
This document describes the governance model for **Harvard Dehallucinator**.

---

## Project Governance Model

Harvard Dehallucinator follows a **Benevolent Dictator For Life (BDFL)** governance model.
