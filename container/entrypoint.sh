...
# Harvard Dehallucinator container entrypoint
#
...
cleanup() {
    echo "Received shutdown signal — stopping harvard-dehallucinator..."
...
echo "Starting harvard-dehallucinator..."
echo "  Host: ${APP_HOST:-[::]}"
...
# Examples:
#   exec /app/harvard-dehallucinator
#   exec /app/release/bin/harvard-dehallucinator start
#   exec /app/harvard-dehallucinator serve --host "${APP_HOST}" --port "${APP_PORT}"
