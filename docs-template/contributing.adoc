...
= Contributing — Harvard Dehallucinator
:revdate: 2026-MM-DD

== Audience

Developers working *on* `Harvard Dehallucinator`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/Harvard Dehallucinator.git
...
* Bugs in `Harvard Dehallucinator`: file at `hyperpolymath/Harvard Dehallucinator/issues`.
