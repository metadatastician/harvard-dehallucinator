...
= Troubleshooting — Harvard Dehallucinator
:revdate: 2026-MM-DD
...
* `https://github.com/hyperpolymath/Harvard Dehallucinator/issues?q=is%3Aissue+<your symptom>` — has anyone hit this before?
