...
// Replace harvard-dehallucinator, Rsr Template Repo — See README.adoc for details., just run, Rsr Template Repo started successfully. with actuals
= harvard-dehallucinator — Quick Start for Users
:toc:
:toclevels: 2

== What is harvard-dehallucinator?
...
[source,bash]
----
just install --portable --prefix=./harvard-dehallucinator-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/harvard-dehallucinator/wiki
