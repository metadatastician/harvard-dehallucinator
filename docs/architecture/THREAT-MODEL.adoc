...
# Threat Model: Harvard Dehallucinator
...
Brief description of Harvard Dehallucinator and its architecture.
...
| Dependencies          | Public         | Lockfile     | Cargo.lock, .lock, gleam.toml          |
