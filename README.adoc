...
image:https://api.scorecard.dev/projects/github.com/hyperpolymath/harvard-dehallucinator/badge[OpenSSF Scorecard,link="https://scorecard.dev/viewer/?uri=github.com/hyperpolymath/harvard-dehallucinator"]
image:https://sonarcloud.io/api/project_badges/measure?project=hyperpolymath_harvard-dehallucinator&metric=alert_status[SonarQube Quality Gate,link="https://sonarcloud.io/summary/new_code?id=hyperpolymath_harvard-dehallucinator"]
image:https://archive.softwareheritage.org/badge/origin/https://github.com/hyperpolymath/harvard-dehallucinator/[Archived in Software Heritage,link="https://archive.softwareheritage.org/browse/origin/?origin_url=https://github.com/hyperpolymath/harvard-dehallucinator"]
...
An external state-management orchestration framework for LLM agents: task state lives outside the context window, and only an independent verifier may write COMPLETE.
